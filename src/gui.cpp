...
extern "C"
{
  ...
  {
    IGUIFont *irrfont = (IGUIFont *)font;
    if (control != NULL)
    {
      switch (ControlType(control))
      {
      case CONTROL_BUTTON:
        ((IGUIButton *)control)->setOverrideFont(irrfont);
        break;
      case CONTROL_EDITBOX:
        ((IGUIEditBox *)control)->setOverrideFont(irrfont);
        break;
      case CONTROL_TEXT:
        ((IGUIStaticText *)control)->setOverrideFont(irrfont);
        break;
      }
    }
    else
    {
      _asGUI()->getSkin()->setFont(irrfont);
    }
  }
  ...
  EXPORT Font *CALL ControlFont(IGUIElement *control)
  {
    ...
    {
    case CONTROL_BUTTON:
      return (Font *)((IGUIButton *)control)->getOverrideFont();
    case CONTROL_EDITBOX:
      return (Font *)((IGUIEditBox *)control)->getOverrideFont();
    case CONTROL_TEXT:
      return (Font *)((IGUIStaticText *)control)->getOverrideFont();
    default:
      return NULL;
    }
  }
