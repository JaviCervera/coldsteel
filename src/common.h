...
// Blend modes
#define ASBLEND_SOLID 0
#define ASBLEND_LIGHTMAP 1
#define ASBLEND_LIGHTMAP2X 2
#define ASBLEND_LIGHTMAP4X 3
#define ASBLEND_DETAIL 4
#define ASBLEND_ADD 5
#define ASBLEND_ALPHA 6
#define ASBLEND_VERTEXALPHA 7
#define ASBLEND_MASKED 8
#define ASBLEND_SPHERE 9
#define ASBLEND_REFLECTION 10
#define ASBLEND_NORMAL 11
#define ASBLEND_NORMALADD 12
#define ASBLEND_PARALLAX 13
#define ASBLEND_PARALLAXADD 14
