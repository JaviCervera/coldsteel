...
cd lib/sdl2
cmake -G "MinGW Makefiles" -DCMAKE_C_FLAGS=-m32 -DCMAKE_BUILD_TYPE=Release -DSDL_SHARED=OFF -DVIDEO_VULKAN=OFF -DVIDEO_OPENGLES=OFF -DDIRECTX=OFF -DRENDER_D3D=OFF ../../lib/sdl2 -B ../../_CMAKE/_SDL2
cd ../../_CMAKE/_SDL2
mingw32-make
cd ../..
